...
<<<<<<< HEAD
  ...
  tags$div(
    ...
    tags$ol(
      tags$li("Vous avez une grille de Picross de taille spécifiée."),
      tags$li("Chaque ligne et chaque colonne de la grille a une série d'indices."),
      tags$li("Ces indices indiquent la longueur des blocs de cases remplies dans cette ligne ou colonne."),
      tags$li("Utilisez les boutons pour remplir ou effacer les cases de la grille."),
